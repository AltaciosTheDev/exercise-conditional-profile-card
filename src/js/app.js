...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <h1>${variables.name == null ? "Enzo" : variables.name} ${
    variables.lastName == null ? "Altamirano" : variables.lastName
  }</h1>
          <h2>${
            variables.role == null ? "4Geeks Latam Student" : variables.role
          }</h2>
          <h3>${variables.city == null ? "San Pedro Sula" : variables.city}, ${
    variables.country == null ? "Honduras" : variables.country
  }</h3>
          <ul class="${variables.socialMediaPosition}">
            <li><a href="https://twitter.com/4geeksacademy"><i class="fab fa-twitter"></i>${
              variables.twitter == null ? "enzoalturcios" : variables.twitter
            }</a></li>
            <li><a href="https://github.com/4geeksacademy"><i class="fab fa-github"></i>${
              variables.github == null ? "AltaciosTheDev" : variables.github
            }</a></li>
            <li><a href="https://linkedin.com/school/4geeksacademy"><i class="fab fa-linkedin"></i>${
              variables.linkedin == null ? "EnzoAltamirano" : variables.linkedin
            }</a></li>
